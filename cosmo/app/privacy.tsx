...
const PRIVACY_SECTIONS = [
    ...
    },
    {
        ...
        content: 'Cosmo AI supports on-device AI processing. When using local models, your conversations stay on your device and are never sent to our servers.',
    },
    {
    ...
    },
    {
        ...
        content: 'Cosmo AI is not intended for users under 13. We do not knowingly collect personal information from children. If we learn of such collection, we will promptly delete it.',
    },
    {
    ...
    {
        title: 'Contact Us',
        content: 'For privacy-related questions or to exercise your rights, contact us at privacy@Cosmoai.app or support@Cosmoai.app.',
    },
];
        ...
        <SafeAreaView style={[styles.container, { backgroundColor: theme.colors.background }]}>
            ...
            <ScrollView contentContainerStyle={styles.content}>
                ...
                <Text style={[styles.footer, { color: theme.colors.textMuted }]}>
                    By using Cosmo AI, you consent to our privacy practices as described in this policy.
                </Text>
            </ScrollView>
        </SafeAreaView>
    );
