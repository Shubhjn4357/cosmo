...
const TERMS_SUMMARY = `
By using Cosmo AI, you agree to our Terms of Service:
...
• No Liability: Cosmo AI is provided "as is". Developers are not liable for AI responses or actions taken based on them.
...
export default function ConsentScreen() {
    ...
    const handleDecline = () => {
        Alert.alert(
            'Consent Required',
            'You must accept the terms to use Cosmo AI. The app will close.',
            [
