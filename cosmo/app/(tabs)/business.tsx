...
import { businessAgentService, BusinessSession, BusinessTask } from '@/services/BusinessAgentService';
            ...
            >
                <View style={styles.taskHeader}>
                    <View style={styles.taskRole}>
                        <Ionicons name={ROLE_ICONS[task.assigned_to] as any} size={16} color={theme.colors.primary} />
