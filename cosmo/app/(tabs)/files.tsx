...
import { cosmoAPI, FileReadResponse, FileAnalyzeResponse } from '@/services/api';
...
export default function FilesScreen() {
    ...
    const readFile = async () => {
        ...
        try {
            const result = await cosmoAPI.readFile(selectedFile);
    ...
    const analyzeFile = async () => {
        ...
        try {
            const result = await cosmoAPI.analyzeFile(selectedFile, question);
            setAnswer(result);
        } catch (err) {
                            ...
                            {answer && (
                                <View style={[styles.answerBox, { backgroundColor: theme.colors.aiBubble, borderColor: theme.colors.surfaceBorder }]}>
                                    <View style={styles.answerHeader}>
                                        ...
                                        <Text style={[styles.answerLabel, { color: theme.colors.accent }]}>Cosmo's Answer</Text>
                                    </View>
