...
import { type LLMModel, cosmoAPI } from '@/services/api';
...
export default function ModelsScreen() {
    ...
    const loadApprovedModels = async () => {
        ...
        try {
            const serverModels = await cosmoAPI.getLLMModels();
    ...
    const renderListHeader = () => (
        <>
            ...
            <View style={styles.section}>
                ...
                <Text style={[styles.sectionSubtitle, { color: theme.colors.textSecondary }]}>Switch between hosted Gemini, your Cosmo server, the self-learner transformer, and on-device GGUF inference.</Text>
