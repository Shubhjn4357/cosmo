...
const PERMISSION_KEY = 'Cosmo_permissions_requested';
...
function handlePermissionDenied(permissionName: string, purpose: string): void {
    Alert.alert(
        ...
        `Cosmo AI needs ${permissionName.toLowerCase()} access to ${purpose}. You can enable this in Settings.`,
        [
