"""
Cosmo AI - Data Persistence via HuggingFace Datasets
...
MYTHOS_GRAPH_PATH = DATA_ROOT / "knowledge" / "cosmo_mythos" / "graph.jsonl"
BUSINESS_SESSIONS_DIR = DATA_ROOT / "runtime" / "business_sessions"
...
def get_persist_directories() -> list[str]:
    ...
    directories.append(str(BUSINESS_SESSIONS_DIR))
    return directories
...
def append_training_pair(user_input: str, ai_response: str, model: str = "cosmo"):
    """
