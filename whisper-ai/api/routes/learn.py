...
AUTO_TRAIN_THRESHOLD = int(os.getenv("WHISPER_SELF_LEARNER_AUTO_TRAIN_MIN_NEW_PAIRS", "8"))
AUTO_TRAIN_STEPS = int(os.getenv("WHISPER_SELF_LEARNER_AUTO_TRAIN_STEPS", "64"))
...
def _maybe_start_self_learner_training(current_count: int):
    ...
    if os.getenv("WHISPER_SELF_LEARNER_AUTO_TRAINING", "true").lower() != "true":
        return
