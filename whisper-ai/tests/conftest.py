...
def server(tmp_path_factory: pytest.TempPathFactory) -> TestServer:
    ...
    temp_root = tmp_path_factory.mktemp("whisper-test")
    ...
    env.update(
        {
            ...
            "WHISPER_DATA_ROOT": str(data_root),
            "WHISPER_UPLOADS_DIR": str(uploads_dir),
            "WHISPER_MODELS_DIR": str(models_dir),
            "WHISPER_RUNTIME_CONFIG": str(runtime_config),
