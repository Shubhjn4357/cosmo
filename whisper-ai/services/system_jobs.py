...
def refresh_job_state(state: Any) -> dict[str, Any]:
...
def start_training_job(state: Any, steps: int) -> dict[str, Any]:
...
def stop_training_job(state: Any) -> dict[str, Any]:
...
def start_generator_job(state: Any) -> dict[str, Any]:
    status = refresh_job_state(state)
...
def stop_generator_job(state: Any) -> dict[str, Any]:
    refresh_job_state(state)
