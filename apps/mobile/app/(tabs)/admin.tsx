...
const DEFAULT_SERVER_URL = 'https://shubhjn-Cosmo-ai.hf.space';
                ...
                <View style={styles.loginContainer}>
                    ...
                    <View style={styles.serverUrlContainer}>
                        ...
                        <TextInput
                            ...
                            placeholder="https://shubhjn-Cosmo-ai.hf.space"
                            placeholderTextColor={theme.colors.textSecondary}
                        />
                    </View>
                </View>
                ...
                <View style={styles.agentWalletBox}>
                    ...
                    <View style={styles.balanceRow}>
                        <Text style={[styles.balanceValue, { color: theme.colors.primary }]}>
                            {typeof agentStatus?.wallet.balance === 'number' 
                                ? agentStatus.wallet.balance.toFixed(6) 
                                : '0.000'} ETH
                        </Text>
