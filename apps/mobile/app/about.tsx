        ...
        <SafeAreaView style={[styles.container, { backgroundColor: theme.colors.background }]}>
            ...
            <ScrollView contentContainerStyle={styles.content}>
                ...
                <View style={styles.logoSection}>
                    ...
                    <Text style={[styles.appName, { color: theme.colors.text }]}>Cosmo AI</Text>
                ...
                <View style={[styles.card, { backgroundColor: theme.colors.surface }]}>
                    <Text style={[styles.description, { color: theme.colors.text }]}>
                        Cosmo AI is a powerful, privacy-focused AI assistant that runs on-device and in the cloud. 
                        Built with cutting-edge machine learning technology, Cosmo helps you with chat, image generation, 
                ...
                <View style={[styles.card, { backgroundColor: theme.colors.surface }]}>
                    <TouchableOpacity 
                        ...
                        onPress={() => Linking.openURL('https://github.com/Cosmoai')}
                    >
                    ...
                    <TouchableOpacity 
                        style={styles.linkRow}
                        onPress={() => Linking.openURL('https://twitter.com/Cosmoai')}
                    >
                    ...
                    <TouchableOpacity 
                        style={styles.linkRow}
                        onPress={() => Linking.openURL('mailto:support@Cosmoai.app')}
                    >
                ...
                <Text style={[styles.copyright, { color: theme.colors.textMuted }]}>
                    © 2024 Cosmo AI. All rights reserved.
                </Text>
            </ScrollView>
        </SafeAreaView>
    );
