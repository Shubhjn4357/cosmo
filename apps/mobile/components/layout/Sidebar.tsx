...
export default function Sidebar({
    ...
    const groupedHistory = history.reduce((acc, chat) => {
        const date = formatDate(chat.updated_at || chat.created_at || new Date().toISOString());
        ...
        <>
            <View style={styles.header}>
                <View style={styles.logoRow}>
                    ...
                    <Text style={[styles.logoText, { color: theme.colors.text }]}>Cosmo AI</Text>
                </View>
                <TouchableOpacity
