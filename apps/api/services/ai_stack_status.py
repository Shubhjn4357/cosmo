    ...
    return {
        ...
        "defaults": {
            "ocr": {
                ...
                "fallback_model": (
                    get_ocr_model(DEFAULT_FALLBACK_OCR_MODEL_ID).to_payload()  # type: ignore
            ...
            "speech": {
                "stt_model": (
                    get_speech_model(DEFAULT_SPEECH_STT_MODEL_ID).to_payload()  # type: ignore
                    if get_speech_model(DEFAULT_SPEECH_STT_MODEL_ID) is not None
                    else None
                ),
                "tts_model": (
                    get_speech_model(DEFAULT_SPEECH_TTS_MODEL_ID).to_payload()  # type: ignore
