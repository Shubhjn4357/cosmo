"""
Canonical approved model catalog for Cosmo server and mobile clients.
...
APPROVED_TEXT_MODELS: tuple[TextModelSpec, ...] = (
    ...
    TextModelSpec(
        id="gemma-4-e2b-uncensored-q4km",
        name="Gemma 4 E2B Uncensored GGUF",
        description="Current lighter Gemma 4 uncensored local build using the newer text-only English-only prune for smaller installs.",
        repo_id="Handyfff/Gemma-4-E2B-uncensored-pruned-TextOnly-EnglishOnly-GGUF",
        filename="Gemma-4-E2B-uncensored-pruned-TextOnly-EnglishOnly-Q4_K_M.gguf",
        size_mb=2769,
        ram_required_gb=4.5,
        speed="medium",
        quantization="Q4_K_M",
        adult=True,
        roles=("adult", "chat", "roleplay", "assistant"),
        tags=("adult", "gguf", "gemma4", "uncensored", "text-only"),
    ),
    TextModelSpec(
        id="gemma-4-e4b-uncensored-q4km",
        name="Gemma 4 E4B Uncensored GGUF",
        description="Higher-capacity Gemma 4 uncensored option for stronger local roleplay and unrestricted assistant output.",
        repo_id="Handyfff/Gemma-4-E4B-it-uncensored-pruned-TextOnly-EnglishOnly-GGUF",
        filename="Gemma-4-E4B-it-uncensored-pruned-TextOnly-EnglishOnly-Q4_K_M.gguf",
        size_mb=4455,
        ram_required_gb=6.6,
        speed="slow",
        quantization="Q4_K_M",
        adult=True,
        roles=("adult", "chat", "roleplay", "creative"),
        tags=("adult", "gguf", "gemma4", "uncensored", "text-only"),
    ),
    TextModelSpec(
...
APPROVED_SPEECH_MODELS: tuple[SpeechModelSpec, ...] = (
    ...
    SpeechModelSpec(
        id="local-cosmo-base",
        name="Local Cosmo Base",
        description="Local Cosmo transcription backend for offline or self-hosted speech-to-text.",
        provider="builtin",
        capabilities=("stt",),
        speed="medium",
        supports_local=True,
...
DEFAULT_SPEECH_STT_MODEL_ID = "openai-cosmo-1"
