...
class HuggingFaceKeepalive:
    def __init__(self, api_key: str = None, interval_minutes: int = 30):  # type: ignore
        """
...
def keepalive_enabled() -> bool:
    return os.getenv("COSMO_HF_KEEPALIVE_ENABLED", "false").lower() == "true"

def get_keepalive(api_key: str = None, interval_minutes: int = 30) -> HuggingFaceKeepalive:  # type: ignore
