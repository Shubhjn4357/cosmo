...
def get_huggingface_enabled() -> bool:
    """Wrapper for generic model toggle logic."""
    return get_model_enabled("huggingface", default=True)


def set_huggingface_enabled(enabled: bool) -> bool:
    """Wrapper for generic model toggle logic."""
    set_model_enabled("huggingface", enabled)
    return enabled


def set_image_enabled(model_id: str, enabled: bool) -> bool:
    """Generic wrapper for model enablement."""
