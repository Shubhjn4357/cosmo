...
import { authAPI, profileAPI, UserProfile, AuthSession } from '@/services/profileAPI';

// Storage keys
const STORAGE_KEYS = {
    ONBOARDING_COMPLETE: 'Whisper_onboarding_complete',
    CONSENT_GIVEN: 'Whisper_consent_given',
    SESSION: 'Whisper_session',
};
...
export function AuthProvider({ children }: { children: ReactNode }) {
    ...
    const loadProfile = async (userId: string) => {
        try {
            ...
            const localConsent = await AsyncStorage.getItem(STORAGE_KEYS.CONSENT_GIVEN);
