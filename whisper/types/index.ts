...
// server: Whisper server runtime
// self-learner: scratch-built Whisper transformer running on the server
...
export const MODEL_MODE_DESCRIPTIONS: Record<ModelType, string> = {
    ...
    server: 'Your Whisper server runtime and installed profiles.',
    'self-learner': 'Scratch-built Whisper transformer with automatic learning.',
